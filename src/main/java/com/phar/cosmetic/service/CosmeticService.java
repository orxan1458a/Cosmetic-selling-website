...
public interface CosmeticService {
    void add(String productName, String brendName, Long cosmeticCode,Double firstPrice, Double price, String productAbout, String category,String subCategory, String  image);
    ...
    void update(Long id,String name,String brandName,String category,Long cosmeticCode,Double price,String productAbout);
